...
public class RFIDScanner
{
    ...
    RFIDScanner(Purse purse, boolean config)
    {
        this.myPurse = purse;
        this.config = config;
    ...
    public static void main(String[] args) {
        RFIDScanner rfid = new RFIDScanner(new Purse("Lukas", new ArrayList<MoneyPiece>()), true);
        while(true)
    ...
    public String scan()
    {
        ...
        try {
            ...
            Logger.getLogger(RFIDScanner.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            sleep(500);
        } catch (InterruptedException ex) {
    ...
    private boolean oeffneSerialPort(String portName)
    {
        ...
        try {
            serialPort.addEventListener(new RFIDScanner.serialPortEventListener());
